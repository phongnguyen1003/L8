            ...
            <section class="wrapper" id="abcde">
                <div class="table-agile-info">
                    ...
                    <div class="panel panel-default">
                        ...
                        <form style="margin-bottom: 20px;float: right; margin-right: 50px;margin-top: 20px;"
                            action="{{URL::to('timkiem')}}" method="POST">
                            {{csrf_field()}}

                            <input style="background: #c9302c; border: none;  box-shadow: none;" type="text"
                                name="keywords_submit" class="form-control" placeholder="Tìm kiếm bài viết">
