...
class ExampleTest extends DuskTestCase
{
    ...
    //                 -> pause(2999)
    //                 -> type('#name2','manhlinh23')
    //                 -> type('#email','linhbathai@gmail.com')
    //                 -> type('#user_mobile','0395608800')
    //                 -> type('#password2','23051998')
    //                 -> type('#password-confirm','23051998')
    ...
    //đang lỗi load ảnh không biets phải do website của họ không
